...
governance_sha: "a2d6c33"
content_version: "6c4e383de7be"
...
La tonalità è la sfumatura di colore che desideri, e va da zero fino a 360. Forse immagina un arcobaleno. Ecco come la immagino io. A sinistra abbiamo il rosso, e poi abbiamo arancione, giallo, verde, blu, viola, e in realtà torniamo di nuovo fino al rosso. Quindi se dici zero, inizi a sinistra, ed è rosso. Se dici `120`, stai chiedendo il verde. E `230` è il blu. Puoi anche pensarlo come una ruota dei colori (_color wheel_ in inglese), che è ciò che rappresentano i 360. È il numero di gradi in un cerchio. Io guardo semplicemente i numeri che mi servono, quindi non preoccuparti troppo di cercare di memorizzarli, ma è utile sapere cosa succede. Quindi ecco la tonalità, cioè la sfumatura (_shade_ in inglese). Poi abbiamo la saturazione, che indica quanto è intenso il colore. Va da zero a 100. A zero, ottieni solo grigio. Non c'è colore, nessun tono. A 100, ottieni un colore pieno, vivo, vibrante. E poi abbiamo la luminosità. La luminosità indica quanto è luminoso il colore, e anche questa va da zero a 100. A zero ottieni il nero. Indipendentemente dalla tonalità scelta, otterrai il nero. Non c'è luce. E a 100 ottieni il bianco. Indipendentemente da tutto il resto, è pieno di luce, quindi è bianco. 50 è esattamente nel mezzo, il colore "normale". Quindi puoi pensarlo come uno slider per rendere il colore più chiaro o più scuro.

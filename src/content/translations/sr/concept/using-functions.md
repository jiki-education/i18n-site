...
Hajde da počnemo tako što ćemo pogledati jedan od osnovnih pojmova u programiranju, funkcije (engl. _functions_). Funkcije su kao male mašine koje možeš da kažeš Džikiju da upotrebi, i ako zavirimo u Džikijevo skladište, gde se on obično nalazi, videćeš da ima policu sa tri različite mašine: `move` (pomeri se), `turnLeft` (skreni levo) i `turnRight` (skreni desno).

<img
  class="concept-image"
  src="/static/images/concept-assets/using-functions/warehouse-three-machines.webp"
  alt="Polica u Džikijevom skladištu na kojoj stoje tri mašine: move, turnLeft i turnRight"
  width="500"
  height="371"
/>

Kada napišeš `move`, a zatim te dve zagrade, time govoriš Džikiju da uzme mašinu `move` sa police, okrene ručicu, upali je i upotrebi.

<img
  class="concept-image"
  src="/static/images/concept-assets/using-functions/jiki-using-move-1.webp"
  alt="Džiki dokotrlja mašinu move sa police da bi je upotrebio"
  width="439"
  height="400"
/>

Kada napišeš `turnLeft`, a zatim zagrade, govoriš Džikiju da uzme mašinu `turnLeft` sa police i upotrebi je. To je šablon koji ćeš koristiti iznova i iznova. Kad god želiš da upotrebiš neku mašinu, napisaćeš njeno ime i zagrade, i to će reći Džikiju da donese mašinu i upotrebi je:

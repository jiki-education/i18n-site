...
তাই Mr Pitt যখন হুট করে ঢুকে পড়েন, তখন আপনাকে বুঝে নিতে হবে যে ইনিই আপনার অ্যারেতে থাকা "Brad Pitt", তারপর তাঁকে জানাতে হবে তিনি কোন টেবিলে বসছেন।
...
- তৃতীয়টি হলো আগত অতিথি, যার ফরম্যাটে প্রথমে সম্মানসূচক সম্বোধন এবং তারপরে পদবি থাকে (যেমন "Mr Pitt")
...
সম্মানসূচক সম্বোধনটি সবসময় ঠিক এক শব্দের হয়, আর তার পরের সবটুকুই অতিথির পদবি। বেশিরভাগ পদবি এক শব্দের, তবে দু-একটি আভিজাত্যপূর্ণ পদবি দুই শব্দেরও হয়।
...
`[...].slice(start)` একটি অ্যারের অংশবিশেষ ধরে নেয়, `start` ইনডেক্স থেকে শুরু করে অ্যারের শেষ পর্যন্ত। নির্বাচিত এলিমেন্টগুলো একটি নতুন অ্যারেতে কপি করা হয়, আর সেটিই আপনাকে রিটার্ন করা হয়। কার্যত, এটি প্রথম `start` সংখ্যক এলিমেন্ট বাদ দিয়ে দেয়। যেমন:

...
4. Повторюємо ці дії з отриманим результатом, і так безкінечно, аж поки не дійдемо до 1.

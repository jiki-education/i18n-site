...
export const LANGUAGES: Record<string, LanguageMeta> = {
  ...
  he: { name: "Hebrew", nativeName: "עברית", dir: "rtl", comingSoon: "בקרוב" },
  hi: { name: "Hindi", nativeName: "हिन्दी", dir: "ltr", comingSoon: "जल्द आ रहा है" },
  hr: { name: "Croatian", nativeName: "Hrvatski", dir: "ltr", comingSoon: "Uskoro" },
  ...
  th: { name: "Thai", nativeName: "ไทย", dir: "ltr", comingSoon: "เร็วๆ นี้" },

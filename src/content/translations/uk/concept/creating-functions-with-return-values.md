...
title: "Повертаємо значення з функцій"
status: "published"
source_repo: "i18n"
...
Ми вже користувалися багатьма функціями, які щось повертають. `isAlienAbove` (чи є прибулець над нами) повертає нам правду або неправду. `Math.randomInt(1, 10)` (`Math`: математика, а `randomInt`: випадкове ціле число) повертає випадкове число.
...
Ключове слово `return` каже міні-Jiki виштовхнути щось назовні через лоток.

...
রিটার্ন করে এমন অনেক ফাংশন আপনি ইতিমধ্যেই ব্যবহার করেছেন। `isAlienAbove` (মানে "উপরে কোনো এলিয়েন আছে কি না") আপনাকে ট্রু বা ফলস ফেরত দেয়। `Math.randomInt(1, 10)` (`Math` মানে গণিত, আর `randomInt` মানে এলোমেলো ইন্টিজার) আপনাকে একটি এলোমেলো সংখ্যা ফেরত দেয়।
...
রিটার্নসহ ফাংশন ইনপুটও নিতে পারে। আপনি হয়তো একটি `ageBracket(age)` (মানে "বয়সসীমা") ফাংশন লিখবেন, যা `age` ১৮-এর কম হলে `"Sorry, too young"` রিটার্ন করে, আর নাহলে `"Welcome"` রিটার্ন করে। যে-ই এটিকে কল করুক, ফাংশনটি যে স্ট্রিং রিটার্ন করেছে সেটিই সে ফেরত পায়।

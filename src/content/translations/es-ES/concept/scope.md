...
status: "published"
source_repo: "i18n"
source_path: "locales/es-ES/curriculum/concepts/scope/page.md"
en_md5: "4d5fc2d1d304725660102e9aaceea4c3"
governance_sha: "16f805d"
content_version: "632ebe193fa0"
...
Al principio, dije que había una regla: las cajas en las estanterías de Jiki deben tener nombres únicos,
...
El scope es algo que al principio probablemente te parecerá bastante sencillo, pero te garantizo que te causará dolores de cabeza por el resto de tu carrera. Incluso los desarrolladores más experimentados se topan con problemas de scope, y JavaScript es uno de los lenguajes más complicados en ese aspecto. Te digo esto para que, cuando te enfrentes a problemas de scope, no te sientas mal contigo. Pero también, presta mucha atención a esta parte porque es importante.

Cuando ves una llave en el código, eso crea lo que se llama un nuevo scope. ¿Qué significa eso? Bueno, puedes imaginarte que Jiki crea un nuevo juego pequeño de estanterías en su taller cada vez que ve una llave. Y todas las cajas que crea mientras trabaja, ejecutando código dentro de esas llaves, esas cajas, esas cajas nuevas van al nuevo juego pequeño de estanterías, no a las principales.

<img
  class="concept-image"
  src="/static/images/concept-assets/scope/shelves.webp"
  alt="Las estanterías principales de Jiki junto a un nuevo juego de estanterías más pequeño creado por una llave"
  width="500"
  height="205"
/>

Y cuando Jiki llega a la llave de cierre correspondiente, tira todas las cajas que están en este juego secundario de estanterías.

<img
  class="concept-image"
  src="/static/images/concept-assets/scope/shelves-loop-end.webp"
  alt="Jiki tirando las cajas del juego secundario de estanterías a la basura cuando llega a la llave de cierre"
  width="500"
  height="237"
/>

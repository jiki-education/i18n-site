...
|---------|---------|------------------|-------|
| developer | desarrollador | es-419 | Prefer gender-neutral rephrasing where practical; see guide § Gender-neutral phrasing. |
...
| template literal | plantilla literal | es-419 | |
...
| return value | valor de retorno | es-419 | Noun form; distinct from the verb "to return". |
...
| mental model | modelo mental | es-419 | The picture-in-your-head framing ("es un modelo mental poderoso"). |
...
| mentor / mentoring | mentor / mentoría | es-419 | Prefer gender-neutral rephrasing where practical; see guide § Gender-neutral phrasing. |
